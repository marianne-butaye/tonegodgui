...
public class TextField extends Element implements Control, KeyboardListener, TabFocusListener, MouseFocusListener, MouseButtonListener {
    ...
    protected String validateAlpha = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ";
    protected String validateAlphaNoSpace = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    protected String validateNumeric = "0123456789.-";
    protected String validateSpecChar = "`~!@#$%^&*()-_=+[]{}\\|;:'\",<.>/?";
    protected String validateCustom = "";
    protected String testString = "Gg|/X";
    protected Element caret;
    protected Material caretMat;
    ...
    protected boolean hasTabFocus = false;
    ...
    protected boolean forceUpperCase = false, forceLowerCase = false;
    protected int maxLength = 0;
    protected String nextChar;
    protected boolean valid;
    protected boolean copy = true, paste = true;
    protected float firstClick = 0, secondClick = 0, compareClick = 0;
    protected float firstClickDiff = 0, secondClickDiff = 0;
    protected boolean doubleClick = false, tripleClick = false;
    ...
    // Validation
    /**
     * Sets the TextField.Type of the text field. This can be used to enforce
     ...
     *
     * @param grabBag String A list of character to either allow or disallow as
     * input
     */
    ...
    public final void setFontSize(float fontSize) {
        this.setFontSizeIntern(fontSize);
    }
    ...
    protected void setCaretPositionToIndex() {
        System.out.println("setCaretPositionToIndex");
        widthTest.setText(".");
        float fixWidth = widthTest.getLineWidth();
        boolean useFix = false;
     ...
     * @param x float
     */
    protected void setCaretPositionByX(float x) {
        System.out.println("setCaretPositionByX");
    ...
    protected void setCaretPositionByXNoRange(float x) {
        System.out.println("setCaretPositionByXNoRange");
        int index1 = visibleText.length();
        if (visibleText.length() > 0) {
            String testString = "";
            widthTest.setText(".");
    ...
    public void setCaretPositionToEnd() {
        System.out.println("setCaretPositionToEnd");
        int index1 = visibleText.length();
        if (visibleText.length() > 0) {
            widthTest.setText(visibleText.substring(0, index1));
            caretX = widthTest.getLineWidth();
     ...
     *
     * @param forceLowerCase true &rarr; force lowercase, false &rarr; don't
     * force
     */
    ...
    public void onGetFocus(MouseMotionEvent evt) {
        if (getIsEnabled()) {
            screen.setCursor(CursorType.TEXT);
        }
        setHasFocus(true);
    }
        ...
        if (this.isEnabled) {
            ...
            switch (clickCount) {
                case 1:
                    firstClick = time;
                    resetTextRange();
                    setCaretPositionByXYNoRange(evt.getX(), evt.getY());
                    if (caretIndex >= 0) {
    ...
    protected void resetClickCounter() {
        System.out.println("resetClickCounter");
        clickCount = 0;
        firstClick = 0;
        secondClick = 0;
        firstClickDiff = 0;
    ...
    protected void stillPressedInterval() {
        System.out.println("stillPressedInterval");
        ...
        setCaretPositionByXYNoRange(screen.getMouseXY().x, screen.getMouseXY().y);
        if (caretIndex >= 0) {
            this.setTextRangeEnd(caretIndex);
        } else {
            this.setTextRangeEnd(0);
    ...
    public void selectTextRangeAll() {
        System.out.println("selectTextRangeAll");
        setTextRangeStart(0);
    ...
    public void selectTextRangeNone() {
        System.out.println("selectTextRangeNone");
        this.resetTextRange();
    }
    ...
    public void selectTextRangeBySubstring(String s) {
        System.out.println("selectTextRangeBySubstring");
    ...
    public void selectTextRangeByIndex(int head, int tail) {
        System.out.println("selectTextRangeByIndex");
        int nHead = head;
        int nTail = tail;
        if (head > tail) {
            nHead = tail;
    ...
    protected void selectTextRangeDoubleClick() {
        if (!finalText.equals("")) {
            int end;
    ...
    protected void selectTextRangeTripleClick() {
        if (!finalText.equals("")) {
            caretIndex = finalText.length();
            updateText(getVisibleText());
            setTextRangeStart(0);
    ...
    protected void setTextRangeStart(int head) {
        System.out.println("setTextRangeStart");
    ...
    protected void resetTextRange() {
        System.out.println("resetTextRange");
        textRangeText = "";
        rangeHead = -1;
        rangeTail = -1;
    ...
    protected void editTextRangeText(String insertText) {
        System.out.println("editTextRangeText");
        int head, tail;
        if (rangeHead != -1 && rangeTail != -1) {
            head = rangeHead;
            tail = rangeTail;

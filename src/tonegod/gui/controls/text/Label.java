...
public class Label extends Element {
    ...
    protected ColorRGBA originalFontColor = null, disabledFontColor = null;
    ...
    public Label(ElementManager screen, String UID, Vector2f position, Vector2f dimensions, Vector4f resizeBorders, String defaultImg) {
        ...
        if (screen.getStyle("Label").getColorRGBA("disabledColor") != null) {
            disabledFontColor = screen.getStyle("Label").getColorRGBA("disabledColor");
        }
    ...
    protected void runDisabledEffect() {
        if (disabledFontColor != null) {
            setFontColor(disabledFontColor);
        }
    }

    protected void runEnabledEffect() {

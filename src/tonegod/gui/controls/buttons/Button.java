...
public abstract class Button extends Element implements Control, MouseButtonListener, MouseFocusListener, KeyboardListener, TabFocusListener {
     ...
     */
    public Button(ElementManager screen, String styleName) {
        this(screen, UIDUtil.getUID(), Vector2f.ZERO,
     ...
     * @param styleName The name of the style to use on the Element
     */
    public Button(ElementManager screen, Vector2f position, String styleName) {
        this(screen, UIDUtil.getUID(), position,
                screen.getStyle(styleName).getVector2f("defaultSize"),
                screen.getStyle(styleName).getVector4f("resizeBorders"),
                screen.getStyle(styleName).getString("defaultImg"),
     ...
     * @param styleName The name of the style to use on the Element
     */
    public Button(ElementManager screen, Vector2f position, Vector2f dimensions, String styleName) {
        this(screen, UIDUtil.getUID(), position, dimensions,
                screen.getStyle(styleName).getVector4f("resizeBorders"),
                screen.getStyle(styleName).getString("defaultImg"),
                styleName
     ...
     * @param styleName The name of the style to use on the Element
     */
    public Button(ElementManager screen, Vector2f position, Vector2f dimensions, Vector4f resizeBorders, String defaultImg, String styleName) {
     ...
     * @param styleName The name of the style to use on the Element
     */
    public Button(ElementManager screen, String UID, Vector2f position, String styleName) {
        this(screen, UID, position,
                screen.getStyle(styleName).getVector2f("defaultSize"),
                screen.getStyle(styleName).getVector4f("resizeBorders"),
                screen.getStyle(styleName).getString("defaultImg"),
     ...
     * @param styleName The name of the style to use on the Element
     */
    public Button(ElementManager screen, String UID, Vector2f position, Vector2f dimensions, String styleName) {
        this(screen, UID, position, dimensions,
                screen.getStyle(styleName).getVector4f("resizeBorders"),
                screen.getStyle(styleName).getString("defaultImg"),
                styleName
     ...
     * @param styleName The name of the style to use on the Element
     */
    public Button(ElementManager screen, String UID, Vector2f position, Vector2f dimensions, Vector4f resizeBorders, String defaultImg, String styleName) {
        super(screen, UID, position, dimensions, resizeBorders, defaultImg);

        this.styleName = styleName;
        this.setScaleNS(false);
        this.setScaleEW(false);
        this.setFontSize(screen.getStyle(styleName).getFloat("fontSize"));
        this.setFontColor(screen.getStyle(styleName).getColorRGBA("fontColor"));
        this.setTextVAlign(BitmapFont.VAlign.valueOf(screen.getStyle(styleName).getString("textVAlign")));
        this.setTextAlign(BitmapFont.Align.valueOf(screen.getStyle(styleName).getString("textAlign")));
        this.setTextWrap(LineWrapMode.valueOf(screen.getStyle(styleName).getString("textWrap")));
        ...
        if (getUseLocalTexture()) {
            ...
            boolean tile = false;
            try {
                tile = screen.getStyle(styleName).getBoolean("tileImages");
            } catch (Exception ex) {
            }
    ...
    /**
     * DefaultStyleName getter.
     * @return The name of the style used on the button when no custom style is specified.
     */
    ...
    /**
     * If called, the icon of the button is modified. This icon is centered
     * by default
     *
    ...
    /**
     * StyleName setter.
     * @param styleName Set the style to be used on the button.
     */
